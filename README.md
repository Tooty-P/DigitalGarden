[README.md](https://github.com/user-attachments/files/29791693/README.md)
# Magic Canvas AI
...
运行后会打开 960x540 的 Pygame 窗口。把手放到摄像头前，食指移动会绘制发光线条。按 `G` 会启动模拟 AI 生成流程，窗口会显示 Loading，完成后右侧会展示生成结果。
